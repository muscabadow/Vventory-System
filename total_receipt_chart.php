...
// TOTAL USERS
$sql = mysqli_query($conn, "SELECT receipt_chart_count(o.action)`count`,o.text,o.icon,o.color,
                            o.action FROM receipt_chart o ORDER BY o.order_by;");


// NEW ORDERS
// $sql1 = mysqli_query($conn, "SELECT COUNT(o.order_id) FROM orders o
//                             WHERE o.order_id NOT IN(SELECT receipt.order_id FROM receipt) AND o.status=1");
// $ress1 = mysqli_fetch_array($sql1);
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h2 class="text-center display-4">Receipt Chart</h2>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="input-group input-group-lg">
                                    <input type="search" name="order" class="form-control form-control-lg custid" autocomplete="off" placeholder="Search Customer ID,Name,Tell and Date Here...">
