  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <h2 class="text-center display-4">Store Out Report</h2>
            <form method="POST">
                <div class="row">
...
<script>
  ...
  //   $.post("get/get_store_out_report.php",data,function(res){
  //     $("#getresult").html(res);
  //   });
  // }); 
  ...
  $(".mybtn").click(function(e){
    ...
    if (store != null) {
      ...
      if (month == null && item == null) {
        month = '';
        item = '';
        var data = "store="+store+"&item="+item+"&month="+month+"&year="+year;
        // alert(data);
      ...
      window.location='store_out_rep.php';
    }
  });
</script>
</body>
