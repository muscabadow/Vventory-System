  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <h2 class="text-center display-4">Expenses Report</h2>
            <form method="POST">
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12">
                              ...
                              <div class="card-body">
                                <div class="row">
                                  <div class="col-5">
                                    <select class="form-control form-control-lg expense">
                                      <option selected disabled>Choose Expense Name</option>
...
<script>
  $(".mybtn").click(function(e){
    ...
    if (expense == null && month == null) {
      alert("Fadlan soo dooro Expense ama Month");
      window.location='expenses_report.php';
      
    }else{
      if (expense == null) {
        expense = '';
        var data = "expense="+expense+"&mon="+month+"&year="+year;
        // alert(data);
        $.post("get/get_expense_rep.php",data,function(res){
  ...
  //   var data = "expense="+expense+"&month="+month+"&year="+year;
  //   // alert(data)
