...
// TOTAL USERS
$sql = mysqli_query($conn, "SELECT `id`, receipt_chart_count(p.action)`count`, `action`, `text`, `icon`, `color`, `order_by` FROM purchase_chart p WHERE p.order_by > 4 ORDER BY p.order_by");
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h2 class="text-center display-4">Payments Chart</h2>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
