...
// TOTAL USERS
$sql = mysqli_query($conn, "SELECT chart_count(o.action)`count`,o.text,o.icon,o.color,
                            o.action FROM order_chart o ORDER BY o.order_by;");
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h2 class="text-center display-4">Orders Chart</h2>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
