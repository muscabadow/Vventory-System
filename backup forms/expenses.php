          ...
          <div class="col-sm-8">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Expense Registration Form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Amount</label>
                    <input type="text" class="form-control" name="bk" placeholder="Amount" required="">
                  </div>
                  <div class="form-group">
                    <label>Reason</label>
                    <input type="text" class="form-control" name="bal" placeholder="Reason" required="">
                  </div>
              ...
              if(isset($_POST["btnreg"])){
                ...
                $insert = mysqli_query($conn, "CALL expenses_sp('$ac','$bk','$ba','$us','$da')");
