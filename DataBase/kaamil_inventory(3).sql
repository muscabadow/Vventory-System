...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 23, 2023 at 04:31 PM
...
(6, 'Seedow Nuur', '+252617890979', 'Gubadleey', 200, 1, '2022-07-29'),
...
(26, 6, 1, 1, 579, 579, 2, 1, '2023-04-19');
...
(8, 11, 1, 600, 100, 0, 500, 2, 1, 25363737, '3353556', 1, '2023-04-19'),
(12, 11, 1, 500, 300, 0, 200, 2, 1, 62378237, '3353556', 1, '2023-04-19');
...
(11, 11, 1, 1, 'Core i7 Ram 16GB HDD 1TB', 2, 300, 600, 2, 1, '2023-04-19');
...
(11, 1, 1, 'Core i7 Ram 16GB HDD 1TB', 2, 300, 600, 2, 1, '2023-04-19');
...
(24, 6, 26, 579, 379, 200, 0, 200, 619630031, 615738336, 23, 2, 1, '2023-04-19');
...
(1, 'Hormuud', 'Bakaaro', 3400, 1, '2022-07-16'),
...
--
ALTER TABLE `receipt`
  MODIFY `rec_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `store_out`
  MODIFY `store_out_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
